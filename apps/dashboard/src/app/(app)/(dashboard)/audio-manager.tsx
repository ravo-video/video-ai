import { constants, Transcriber } from '@repo/whisper';
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center rounded-lg bg-white shadow-xl shadow-black/5 ring-1 ring-slate-700/10">
        <div className="flex w-full flex-row space-x-2 px-2 py-2">
          <UrlTile
            icon={<AnchorIcon />}
            text={'From URL'}
            onUrlUpdate={e => {
        ...
        <>
          ...
          {props.transcriber.multilingual && (
            <>
              ...
              <select
                className="mb-3 mt-1 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
